        ...
        blocks: [
          ...
          },
          {
            ...
            bullets: [
              ...
              '2. On THIS device (the one actually filing reports), turn the "Publish to Command Post Server" toggle on below first — the "Server address" field only appears once it\'s on — then paste that exact address into it. Reports start publishing there automatically from then on, every time one is filed or edited.',
