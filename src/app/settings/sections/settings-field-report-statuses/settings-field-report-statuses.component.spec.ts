...
import { SettingsFieldReportStatusesComponent } from './settings-field-report-statuses.component';
import { FieldReportService } from '../../../shared/services/';

describe('SettingsFieldReportStatusesComponent', () => {
  let component: SettingsFieldReportStatusesComponent;
  let fixture: ComponentFixture<SettingsFieldReportStatusesComponent>;
  let fieldReportService: FieldReportService;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [SettingsFieldReportStatusesComponent],
      providers: [provideHttpClient()],
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(SettingsFieldReportStatusesComponent);
